...
// Local demo posts – later you can replace with real backend/API data
...
const BlogManagement: React.FC = () => {
  ...
  const handleSaveNewPost = (
    newPostData: Omit<BlogPost, 'id' | 'date' | 'content'>,
  ) => {
    const newPost: BlogPost = {
      ...newPostData,
      content: newPostData.excerpt,
      id: `post_${Date.now()}`,
              ...
              >
                ...
                <td className="px-6 py-4 text-right space-x-4">
                  ...
                  <button
                    ...
                    className="font-medium text-red-500 hover:text-red-500/80"
                  >
                    Delete
                  </button>
                </td>
