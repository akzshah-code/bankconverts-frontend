// src/components/admin/AddEmailModal.tsx
...
interface AddEmailModalProps {
  // Parent (EmailAutomations) will add the id
  onSave: (template: EmailTemplateInput) => void;
  onClose: () => void;
}
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              placeholder="e.g., On User Registration"
              required
              className="mt-1 w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-brand-blue focus:border-brand-blue"
            />
          </div>
