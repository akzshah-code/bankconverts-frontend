        ...
        {post ? (
          <article className="max-w-3xl mx-auto">
            <header className="mb-8 text-center border-b pb-8">
              <h1 className="text-4xl md:text-5xl font-bold text-brand-dark leading-tight">{post.title}</h1>
            ...
            {post.featuredImage && (
                <img src={post.featuredImage} alt={post.title} className="w-full rounded-lg mb-8 object-cover" style={{ aspectRatio: '16/9' }} />
            )}

            <div 
              className="prose lg:prose-xl max-w-none text-brand-dark"
